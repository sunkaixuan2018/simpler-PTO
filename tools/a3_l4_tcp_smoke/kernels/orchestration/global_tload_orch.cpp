...
global_tload_orchestration_config(const L2TaskArgs &orch_args) {
    (void)orch_args;
...
__attribute__((visibility("default"))) void global_tload_orchestration(const L2TaskArgs &orch_args) {
    L0TaskArgs params;
