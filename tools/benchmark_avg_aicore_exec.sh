...
results = {
    ...
    "CTRL_SKIP_INSTR_KERNEL_SCHEDULER": find(r"Prefetch task summary: .*?skip_instr_kernel_scheduler=(\d+)"),
    "CTRL_SKIP_INSTR_FEATURE_DISABLED": find(r"Prefetch task summary: .*?skip_instr_feature_disabled=(\d+)"),
...
PROFILE_PREFETCH_CTRL_SKIP_INSTR_KERNEL_SCHEDULER="-"
PROFILE_PREFETCH_CTRL_SKIP_INSTR_FEATURE_DISABLED="-"
        ...
        local prefetch_debug
            ...
            while IFS='=' read -r key value; do
                ...
                case "$key" in
                    ...
                    CTRL_SKIP_INSTR_KERNEL_SCHEDULER) PROFILE_PREFETCH_CTRL_SKIP_INSTR_KERNEL_SCHEDULER="$value" ;;
                    CTRL_SKIP_INSTR_FEATURE_DISABLED) PROFILE_PREFETCH_CTRL_SKIP_INSTR_FEATURE_DISABLED="$value" ;;
...
declare -A SUMMARY_PREFETCH_CTRL_SKIP_INSTR_KERNEL_SCHEDULER=()
declare -A SUMMARY_PREFETCH_CTRL_SKIP_INSTR_FEATURE_DISABLED=()
...
for example in "${EXAMPLE_ORDER[@]}"; do
    ...
    run_one_case() {
        ...
        for mode in "${RUN_MODES[@]}"; do
            ...
            SUMMARY_PREFETCH_CTRL_SKIP_INSTR_KERNEL_SCHEDULER["$mode|$_label"]="$PROFILE_PREFETCH_CTRL_SKIP_INSTR_KERNEL_SCHEDULER"
            SUMMARY_PREFETCH_CTRL_SKIP_INSTR_FEATURE_DISABLED["$mode|$_label"]="$PROFILE_PREFETCH_CTRL_SKIP_INSTR_FEATURE_DISABLED"
