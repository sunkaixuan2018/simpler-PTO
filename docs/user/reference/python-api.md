...
| `enable_chip_swimlane` | `0` | `0` off; `1`–`4` select detail. L2 and same-host L3; a lower level simply records fewer device streams, and cross-Rank merging works at any of them |
