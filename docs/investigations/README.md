...
- [2026-07 — Containing A2/A3 SDMA stream teardown after an AICore fault](2026-07-a2a3-sdma-fault-teardown.md) — no supported application cleanup bypasses CANN's single 300,000 ms remote logic-CQ timeout; ordinary/vector streams cannot provide CP-local SQ registers. Contained by callable-declared, first-use SDMA provisioning; full recovery after genuine SDMA use needs CANN runtime + driver changes (#1425)
