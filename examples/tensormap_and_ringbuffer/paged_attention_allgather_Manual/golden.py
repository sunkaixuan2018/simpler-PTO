...
Each rank independently computes paged attention on its own Q/K/V data,
then AllGather: every rank gets the concatenation of all ranks' first
GATHER_COUNT elements of attn_out.

Same golden logic as paged_attention_allgather_Tgather (Manual uses
direct RDMA reads instead of TGATHER, but output is identical).
"""
...
def compute_golden(tensors: dict, params: dict) -> None:
    ...
    allgather_np = tensors["allgather_out"].cpu().numpy()
