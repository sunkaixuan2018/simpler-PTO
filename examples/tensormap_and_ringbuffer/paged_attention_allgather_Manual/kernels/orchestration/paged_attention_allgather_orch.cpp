...
void aicpu_orchestration_entry(PTO2Runtime* rt, uint64_t* args, int arg_count) {
    ...
    LOG_INFO(rt, "paged_attention_allgather_Manual: n_ranks=%d rank_id=%d batch=%lu",
    ...
    /* Phase 2: AllGather - copy first GATHER_COUNT elements of attn_out, allgather, write to allgather_out */
