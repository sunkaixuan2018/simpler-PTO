"""
Golden reference for fake_kernel_comm_sched_extreme.
...
def post_run_collect(outputs: dict, params: dict) -> None:
    ...
    fname = _OUTPUTS_DIR / f"poll_counts_extreme_{strategy_str}_gc{GATHER_COUNT}_r{n_ranks}.json"
